...
class Calculator:
    ...
    def get_today_stats(self):
        ...
        # Однако в данном случае код менее понятен и строка весьма громоздка:
...
class CaloriesCalculator(Calculator):
    # В данном случае правильнее написать комментарий к функции сверху и по стандартам
    ...
    def get_calories_remained(self):  # Получает остаток калорий на сегодня
        ...
        # else не нужен: при первом условии функция и так завершится.
        else:
            # Скобки излишни
            return('Хватит есть!')
...
class CashCalculator(Calculator):
    ...
    def get_today_cash_remained(self, currency,
        ...
        # Можно без else, только я бы вынес из if-ов самый простой случай с == 0
            ...
            # Для консистентности лучше тоже f-строки использовать, не использовать \
            return 'Денег нет, держись:' \
